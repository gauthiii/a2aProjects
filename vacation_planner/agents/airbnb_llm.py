...
async def airbnb_search_openai(user_input: str,tool_mapping: dict = {}, tool_defs: list = [], model: str = "openai:gpt-4o-mini") -> str: 
    ...
    prompt = f"""
                ...
                You need to help the user with plan his stays and accomodations.
